...
// ==========================================================
// RENOMEAÇÃO DE LOCALIDADES (apenas exibição no gráfico)
// ==========================================================
// Some localidades precisam aparecer com outro nome no gráfico
// de "Chamados por Localidade", sem alterar o valor original da
// planilha (o filtro e a tabela continuam mostrando o nome real).
//
// Para adicionar mais renomeações, basta incluir novas linhas
// no formato "Nome_Na_Planilha": "Nome_Para_Exibir_No_Grafico"

const RENOMEAR_LOCALIDADES = {
    "Positivo": "Comercial / Centro de comando"
};

function nomeExibicaoLocalidade(localidade){
    return RENOMEAR_LOCALIDADES[localidade] || localidade;
}
...
function criarGraficoLocalidades(dados){
    ...
    dados.forEach(item=>{
        ...
        const rotulo = nomeExibicaoLocalidade(localidade);

        contador[rotulo]=(contador[rotulo]||0)+1;
